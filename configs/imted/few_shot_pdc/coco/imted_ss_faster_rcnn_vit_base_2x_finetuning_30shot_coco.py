...
load_from = 'work_dir/base_coco_model/imted_faster_rcnn_vit_base_2x_base_training_coco.pth'
...
data = dict(
    ...
    train=dict(
        ...
        classes = classes, 
        ann_file='datasets/cocosplit/seed0/30shot.json',
        img_prefix='datasets/coco2014/trainval2014/'),
    val=dict(
        classes = classes, 
        ann_file= 'datasets/cocosplit/datasplit/5k_novel.json',
        img_prefix='datasets/coco2014/trainval2014/'),
    test=dict(
        classes = classes, 
        ann_file= 'datasets/cocosplit/datasplit/5k_novel.json',
