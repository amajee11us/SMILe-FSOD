...
class IDDDetectionEvaluator(DatasetEvaluator):
    ...
    def __init__(self, dataset_name):
        ...
        assert meta.year in [2019], meta.year
        self._is_2007 = meta.year == 2019
    ...
    def evaluate(self):
        ...
        self._logger.info(
            ...
            "Note that results do not use the official Matlab API.".format(
                self._dataset_name, 2019
            )
        )

        with tempfile.TemporaryDirectory(prefix="idd_detection_eval_") as dirname:
